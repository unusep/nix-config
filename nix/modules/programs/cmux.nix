...
let
  ...
  keybindings = {
    ...
    "shortcut.nextSurface"    = mkShortcut { key = "o"; cmd = true; shift = true; };
    "shortcut.prevSurface"    = mkShortcut { key = "i"; cmd = true; shift = true; };
    "shortcut.nextSidebarTab" = mkShortcut { key = "o"; cmd = true; ctrl = true; };
    "shortcut.prevSidebarTab" = mkShortcut { key = "i"; cmd = true; ctrl = true; };
    ...
    "shortcut.focusLeft"       = mkShortcut { key = "h"; cmd = true; };
    "shortcut.focusRight"      = mkShortcut { key = "l"; cmd = true; };
    "shortcut.focusUp"         = mkShortcut { key = "k"; cmd = true; };
    "shortcut.focusDown"       = mkShortcut { key = "j"; cmd = true; };
    ...
    "shortcut.openBrowser"       = mkShortcut { key = "l"; cmd = true; shift = true; };
